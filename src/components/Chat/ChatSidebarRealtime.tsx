...
export default function ChatSidebarRealtime({ 
  ...
  const { rooms, isLoading, error, createRoom, refetch } = useRealtimeRooms();
          ...
          <form onSubmit={handleCreateRoom} className="mb-4">
            ...
            <div className="flex gap-2 mt-3">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white rounded-lg text-sm font-medium transition-all shadow-lg shadow-purple-500/20 disabled:shadow-none disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                disabled={isSubmitting}
                className="flex-1 px-4 py-2 bg-[#2a1b3d] hover:bg-[#3a2b4d] disabled:bg-gray-700 text-gray-300 rounded-lg text-sm font-medium transition-all border border-purple-700/30 disabled:opacity-50"
              >
                Cancel
              </button>
            </div>
